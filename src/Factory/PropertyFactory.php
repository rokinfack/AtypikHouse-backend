 ...
 * @method static Property[]|Proxy[] createSequence(array|callable $sequence)
...
final class PropertyFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'type' => self::faker()->randomElement(["bool", "string", "text"]),
    ...
    protected function initialize(): self
    {
        ...
        return $this
            ->afterInstantiate(function (Property $property): void {
                $property->setCategory(CategoryFactory::random()->object());
            });
    }
