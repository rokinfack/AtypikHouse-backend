...
final class UserFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'locale' => self::faker()->randomElement(["fr", "en"]),
            'profileImage' => MediaFactory::random()->object(),
            'birthDay' => self::faker()->dateTime(),
            'phoneNumber' => self::faker()->phoneNumber(),
            'phoneNumberValidated' => self::faker()->boolean(),
    ...
    protected function initialize(): self
    {
        ...
        return $this->afterInstantiate(function (User $user): void {
            $user->setPassword($this->userPasswordHasher->hashPassword($user, "fabien"));
        });
    }
